$(document).ready(function(){
	...
	brand();
	product();
	//cat() is a funtion fetching category records from database whenever page is loaded
	function cat(){
		$.ajax({
			url	:	"action.php",
			method:	"POST",
	...
	//brand() is a funtion fetching brand records from database whenever page is loaded
	function brand(){
		$.ajax({
			url	:	"action.php",
			method:	"POST",
	...
	//product() is a funtion fetching product record from database whenever page is loaded
		function product(){
		$.ajax({
			url	:	"action.php",
			method:	"POST",
	...
	/*	when page is loaded successfully then there is a list of categories. When a user clicks on a category we will get category id and 
	...
	*/
	...
	/*	when page is loaded successfully then there is a list of brands. When user click on brand we will get brand id and 
